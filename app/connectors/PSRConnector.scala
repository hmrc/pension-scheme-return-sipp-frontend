...
class PSRConnector @Inject() (
  ...
  def submitLandOrConnectedProperty(
    ...
    val queryParams = createQueryParamsFromSession(req.session)
    val url =
      makeUrl(s"$baseUrl/land-or-connected-property?journeyType=$journeyType", queryParams, isFirstQueryParam = false)
    submitRequest(request, url)
  }
  ...
  def submitAssetsFromConnectedParty(
    ...
    val queryParams = createQueryParamsFromSession(req.session)
    val url =
      makeUrl(s"$baseUrl/assets-from-connected-party?journeyType=$journeyType", queryParams, isFirstQueryParam = false)
    submitRequest(request, url)
  }
  ...
  def submitTangibleMoveableProperty(
    ...
    val queryParams = createQueryParamsFromSession(req.session)
    val url =
      makeUrl(s"$baseUrl/tangible-moveable-property?journeyType=$journeyType", queryParams, isFirstQueryParam = false)
    submitRequest(request, url)
  }
