...
import repositories.LargeUploadRepository.MongoUpload.SensitiveUpload
...
@Singleton
class LargeUploadRepository @Inject()(mongo: MongoGridFsConnection, crypto: Crypto)(
  ...
  import LargeUploadRepository._
