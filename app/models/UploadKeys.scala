...
object UploadKeys {
  ...
  val memberNinoTangible = "Member National Insurance number"
  val memberReasonNoNinoTangible = "If no National Insurance number for member, give reason"
  ...
  val dateOfAcquisitionTangible = "What was the date of acquisition of the asset?"
  ...
  val namesOfPurchasersTangible = "Names of purchasers"
  val areAnyPurchasersConnectedTangible = "Are any of the purchasers connected parties?"

  val wasTxSupportedIndValuationTangible = "Was the transaction supported by an independent valuation?"
