...
object UploadKeys {
  ...
  val acquiredFromIndividualTangible = "If the asset was acquired from an individual enter the individuals National Insurance Number"
  ...
  val acquiredFromReasonTangible = "Add the reason you do not have the individuals National Insurance number, the CRN or the UTR. Or if the land or property was acquired from another source, enter the details"
  val isIndependentEvaluationTangible = "Is this transaction supported by an Independent Valuation?"
  val totalIncomeInTaxYearTangible = "What is the total amount of income and receipts received in respect of the asset during tax year?"
  val isTotalCostOrMarketValueTangible = "Is the total cost value or market value of the asset?"
  val totalCostOrMarketValueTangible = "What is the total cost value or market value of the asset, as at 6 April [of the tax year that you are submitting]"
  val areAnyDisposalsTangible = "During the year was there any disposal of the tangible moveable property made?"
  val disposalsAmountTangible = "If yes, there was disposal of tangible moveable property - what is the total amount of consideration received from the sale or disposal of the asset?"
  ...
  val disposalTypeOfPurchaser2Tangible = "Is the second purchaser a connected or unconnected party?"
  val disposalNameOfPurchaser3Tangible = "If disposals were made on this, what is the name of the third purchaser?"
  val disposalTypeOfPurchaser3Tangible = "Is the third purchaser a connected or unconnected party?"
  val disposalNameOfPurchaser4Tangible = "If disposals were made on this, what is the name of the fourth purchaser?"
  val disposalTypeOfPurchaser4Tangible = "Is the fourth purchaser a connected or unconnected party?"
  val disposalNameOfPurchaser5Tangible = "If disposals were made on this, what is the name of the fifth purchaser?"
  val disposalTypeOfPurchaser5Tangible = "Is the fifth purchaser a connected or unconnected party?"
  val disposalNameOfPurchaser6Tangible = "If disposals were made on this, what is the name of the sixth purchaser?"
  val disposalTypeOfPurchaser6Tangible = "Is the sixth purchaser a connected or unconnected party?"
  val disposalNameOfPurchaser7Tangible = "If disposals were made on this, what is the name of the seventh purchaser?"
  val disposalTypeOfPurchaser7Tangible = "Is the seventh purchaser a connected or unconnected party?"
  val disposalNameOfPurchaser8Tangible = "If disposals were made on this, what is the name of the eighth purchaser?"
  val disposalTypeOfPurchaser8Tangible = "Is the eighth purchaser a connected or unconnected party?"
  val disposalNameOfPurchaser9Tangible = "If disposals were made on this, what is the name of the ninth purchaser?"
  val disposalTypeOfPurchaser9Tangible = "Is the ninth purchaser a connected or unconnected party?"
  val disposalNameOfPurchaser10Tangible = "If disposals were made on this, what is the name of the tenth purchaser?"
