...
object LandOrConnectedPropertyApi {
  ...
  implicit val landOrConnectedPropertyApiCsvRowEncoder: RowEncoder[TransactionDetail] = { tx =>
    NonEmptyList.of(
      ...
      if (tx.landOrPropertyInUK == YesNo.Yes) tx.addressDetails.addressLine2.mkString else "",
      ...
      if (tx.landOrPropertyInUK == YesNo.No) tx.addressDetails.addressLine2.mkString else "",
