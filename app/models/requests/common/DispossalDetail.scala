...
object DispossalDetail {

  case class PurchaserDetail(
    purchaserConnectedParty: ConnectedOrUnconnectedType,
    purchaserName: String
  )

  implicit val formatPurchaserDetail: OFormat[PurchaserDetail] = Json.format[PurchaserDetail]
  implicit val format: OFormat[DispossalDetail] = Json.format[DispossalDetail]
}
