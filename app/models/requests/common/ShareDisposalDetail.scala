...
case class ShareDisposalDetail(
  totalConsiderationAmountSaleIfAnyDisposal: Double,
...
object ShareDisposalDetail {
  implicit val format: OFormat[ShareDisposalDetail] = Json.format[ShareDisposalDetail]
}
