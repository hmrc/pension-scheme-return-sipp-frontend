...
case class LandOrConnectedPropertyResponse(
  transactions: Option[NonEmptyList[LandOrConnectedPropertyResponse.TransactionDetail]]
)

object LandOrConnectedPropertyResponse {
  ...
  implicit val formatLandConnectedParty: OFormat[LandOrConnectedPropertyResponse] =
