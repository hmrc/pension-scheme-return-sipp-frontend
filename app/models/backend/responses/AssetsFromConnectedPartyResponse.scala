...
case class AssetsFromConnectedPartyResponse(
  transactions: Option[NonEmptyList[AssetsFromConnectedPartyResponse.TransactionDetail]]
)

object AssetsFromConnectedPartyResponse {
  ...
  implicit val formatAssetsFromConnectedParty: OFormat[AssetsFromConnectedPartyResponse] =
