...
case class TangibleMoveablePropertyResponse(
  transactions: Option[NonEmptyList[TangibleMoveablePropertyResponse.TransactionDetail]]
)

object TangibleMoveablePropertyResponse {
  ...
  implicit val formatLandConnectedParty: OFormat[TangibleMoveablePropertyResponse] =
