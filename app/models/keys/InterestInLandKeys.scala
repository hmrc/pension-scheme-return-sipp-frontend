...
object InterestInLandKeys extends CommonKeys {
  ...
  val headers: NonEmptyList[String] = NonEmptyList.of(
    ...
    memberNino,
    memberReasonNoNino,
    countOfInterestLandOrPropertyTransactions,
    acquisitionDate,
  ...
  val helpers: NonEmptyList[String] = NonEmptyList.of(
    ...
    "Enter the first name of the scheme member. Hyphens are accepted. Should be letters A to Z. Mandatory question.",
    "Enter the last name of the scheme member. Hyphens are accepted. Should be letters A to Z. Mandatory question.",
