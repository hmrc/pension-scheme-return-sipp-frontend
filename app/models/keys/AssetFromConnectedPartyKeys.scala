...
object AssetFromConnectedPartyKeys extends CommonKeys {
  ...
  val dateOfAcquisition = "What is the date the scheme acquired the asset?" // G
  val descriptionOfAsset = "Description of asset" // H
  val isAcquisitionOfShares = "Was this an acquisition of shares?" // I
  val companyNameShares = "If yes, what is the name of the company to which the shares relate?" // J
  val companyCRNShares = "What is the CRN of the company to which the shares relate?" // K
  val companyNoCRNReasonShares = "If no CRN of the company to which the shares relate, enter reason" // L
  val companyClassShares = "What are the class of shares?" // M
  val companyNumberOfShares =
    "What are the total number of shares acquired or received/held in respect of this transaction?" // N
  val acquiredFrom = "Who was the asset acquired from?" // O
  val totalCostOfAsset = "What is the total cost of the asset at the date the scheme acquired it?" // P
  val isIndependentValuation = "Is this transaction supported by an Independent Valuation?" // Q
  val isFinanceAct =
    "Is any part of the asset Tangible Moveable Property as defined by Schedule 29a Finance Act 2004?" // R
  val totalIncomeInTaxYear =
    "What is the total amount of income and receipts received in respect of the asset during tax year?" // S
  val areAnyDisposalsYear = "During the year was any disposal of the asset made?" // T
  val disposalsAmount =
    "If disposals were made what is the total amount of consideration received from the sale or disposal of the asset?" // U
  val namesOfPurchasers = "If disposals were made on this, what was the name of the purchasers of the asset?" // V
  val areConnectedPartiesPurchasers = "Are any of the purchasers connected parties?" // W
  val wasTransactionSupportedIndValuation = "Was the transaction supported by an independent valuation?" // X
  val hasFullyDisposedOf = "Has the asset been fully disposed of?" // Y
  val wasDisposalOfShares = "Was there disposal of shares?" // Z
  val disposalOfSharesNumberHeld =
    "If there were disposals of shares what is the total number of shares now held?" // AA
  ...
  val helpers: NonEmptyList[String] = NonEmptyList.of(
    ...
    "Enter the total amount in GBP (in pounds and pence). Enter amount to two decimal places. If the asset was not an acquisition, provide the total market value. If the asset was acquired more than 6 years ago provide the market value at the year of the return. Mandatory question",
    "Enter YES or NO. Mandatory question",
    "Enter YES or NO. Mandatory question",
